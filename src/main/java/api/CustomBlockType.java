...
public enum CustomBlockType {// implements Consumer<Block>
	...
	BLAST_FURNACE("BlastFurnace", "Blast Furnace Output", Material.HOPPER, new Vector(0.5, 0.075, 0.5), new ItemStack(Material.AIR)),
	...
	ZAUBER_CAULDRON("ZauberCauldron", "Zauber Cauldron", Material.CAULDRON, new Vector(0.5, 0.075, 0.5), new ItemStack(Material.AIR)),
	LIQUID_TANK("LiquidTank", "Liquid Tank", Material.HOPPER, new Vector(0.5, 0.075, 0.5), new ItemStack(Material.AIR)),
	...
	CustomBlockType(String id, String name, Material type, Vector offset, ItemStack helmet) {
		this.id = id;
		this.name = name;
		this.type = type;
		this.offset = offset;
	...
	CustomBlockType(String id, String name, Material type, Vector offset, ItemStack helmet, EulerAngle headPose) {
		this.id = id;
		this.name = name;
		this.type = type;
		this.offset = offset;
	...
	CustomBlockType(String id, String name, Material type, Vector offset, ItemStack helmet, Consumer<Block> consumer) {
		this.id = id;
		this.name = name;
		this.type = type;
		this.offset = offset;
