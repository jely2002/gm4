...
public enum BiomeGroup {
	SNOWY(0) {
		public List<Biome> biomes() {
			return Arrays.asList(Biome.SNOWY_TAIGA, Biome.SNOWY_BEACH, Biome.SNOWY_TUNDRA, Biome.SNOWY_MOUNTAINS, Biome.SNOWY_TAIGA_HILLS, Biome.SNOWY_TAIGA_MOUNTAINS, Biome.FROZEN_RIVER, Biome.ICE_SPIKES);
		}
	},
	COLD(1),
	LUSH(2),
	...
	private int value;
	private BiomeGroup(int value) { this.value = value; }
...
//	}
	...
	public static List<Biome> getBiomes(BiomeGroup group) {
		switch (group) {
			...
			case OCEAN: return Arrays.asList(Biome.OCEAN, Biome.DEEP_OCEAN, Biome.FROZEN_OCEAN, Biome.DEEP_FROZEN_OCEAN, Biome.COLD_OCEAN, Biome.DEEP_COLD_OCEAN, Biome.LUKEWARM_OCEAN, Biome.DEEP_LUKEWARM_OCEAN, Biome.WARM_OCEAN, Biome.DEEP_WARM_OCEAN);
